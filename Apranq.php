...
<head>
    ...
    <link rel="stylesheet" href="./css/aparikStyle.css">
    <link rel="stylesheet" href="./css/aparikMedia768.css">
    <link rel="stylesheet" href="./css/mainAll.css">
     <link rel="stylesheet" href="./css/aparikMedia375.css">
...
<body>
  <div class="header" id="header">
    ...
    >
      ...
      <li><a href="Blog.html">Բլոգ</a><img src="./img/arrow-right-menu.png" class="arrow-right-menu"></li>
      <li><a href="Contact.html" >Կապ</a><img src="./img/arrow-right-menu.png" class="arrow-right-menu"></li>
      <li><a href="Hashvich.html">Առցանց հաշվիչ</a><img src="./img/arrow-right-menu.png" class="arrow-right-menu"></li>
      ...
      <div class="container">
        ...
        <div class="contect__breadcrumb">
          ...
          <?php
            ...
            echo '<p>'.$value['name'].' '.$value['type'].'</p>' 
          ?>
        </div>
